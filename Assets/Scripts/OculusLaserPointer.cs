...
public class OculusLaserPointer : OVRCursor
{
    ...
    [SerializeField] GameObject startPointObj, endPointObj;
    ...
    public static OculusLaserPointer instance
    {
        ...
        get
        {
            if (_instance == null) {
                ...
                _instance = (OculusLaserPointer)GameObject.Instantiate((OculusLaserPointer)Resources.Load("Prefabs/GazePointerRing", typeof(OVRGazePointer)));
            }
            return _instance;
        }
